...
async def test_reindex_sqlite_backed_qdrant_restores_supported_surfaces(client) -> None:
    ...
    await store.upsert(
        ...
        "Canonical memory restored from SQLite.",
        {
            ...
            "source": "conversation",
            "tags": ["project:mnemoforge", "restore"],
            "status": None,
            "project": "mnemoforge",
            "scope": "project",
            "meta": {"kind": "note"},
    ...
    await store.upsert(
        ...
        "# Memoir: Restore\n\nRecovered from SQLite.",
        {
            ...
            "tags": ["memoir", "project:mnemoforge"],
            "project": "mnemoforge",
    ...
    await store.upsert(
        ...
        "Overview section rebuilt from SQLite.",
        {
            ...
            "tags": ["doc_section", "project:mnemoforge", "section:overview"],
            "status": "active",
            "project": "mnemoforge",
            "scope": "project",
    ...
    task_store.upsert_task(
        ...
        status="active",
        source="project_task",
        tags=["project:mnemoforge", "task_id:restore-task"],
