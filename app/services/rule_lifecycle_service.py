...
from app.models.law import ProjectLawCreate, ProjectLawUpdate
from app.services.law_service import create_project_law, get_project_law, list_project_laws, update_project_law
        ...
        with self._lock:
            ...
            self._conn.execute(
                ...
                INSERT INTO rule_candidates (
                    ...
                    promotion_hint, related_rule_hint, status, created_at, updated_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    candidate_id,
