...
#!/usr/bin/env python3
"""
SloplessCode - client connectivity test.
Server: {server_url}
...
#!/usr/bin/env python3
"""
SloplessCode - client auto-setup script.
Generated by: {server_url}/client-setup

What this script does:
  1. Creates ~/sloplesscode-client/ directory
...
HOME       = Path.home()
CLIENT_DIR = HOME / "sloplesscode-client"
...
if claude_bin is None:
    ...
    if result.returncode == 0:
        log("Registered compatibility MCP alias 'mnemoforge' (user scope)")
    else:
        # Old syntax fallback
