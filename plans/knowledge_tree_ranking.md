...
### Проблема
Текущая система semantic search в supermemory использует плоскую модель хранения и поиска знаний. Все воспоминания хранятся с одинаковым приоритетом, и поиск возвращает результаты, отсортированные только по семантической близости и важности.
